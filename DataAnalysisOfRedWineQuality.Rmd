...
```
citric.acid is inversely related with volatile.acidity. It might be the case that during wine preparation, not too much volatile acidity will be added if there is already good amount of fixed acidity present due to citric acid. This will help keeping the total acidity of wine to acceptable level.
